...
#if defined(PDEDEBTB)
                //beacause target address was partitioned while storing
                //we'll reconstruct target here
                uint64_t target = BTB.reconstruct_target_data(arch_instr.ip, btb_set, btb_way);
